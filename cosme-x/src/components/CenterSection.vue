<template>
    <div class="flex flex-col items-center w-full h-full">
        ...
        <div class="my-2 text-4xl font-extrabold glowing-text">COSME X</div>
        ...
        <div class="relative inline-block p-1 cursor-pointer" @mouseover="hoverGear" @mouseleave="leaveGear">
            ...
            <!-- 用svg替换q-icon，适配所有环境 -->
            <svg
                :class="['settings-icon', { 'rotate-gear': rotating, 'reverse-rotate-gear': reverseRotating }]"
                @click="goToSettings"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                class="text-gray-500 w-12 h-12 mx-auto"
