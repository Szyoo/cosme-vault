...
const zh = {
  ...
  runner: {
    ...
    confirmDraw: "将真实投递现有的「待投递」奖品（每账号一批最多 30 个），抽奖机会用掉就没了。",
    confirmRun: "将扫描全部来源，然后自动投递（每账号一批最多 30 个），抽奖机会用掉就没了。",
    confirmGo: "确认，开始",
    confirmNo: "算了",
    runFailed: "触发失败",
...
const ja: Dict = {
  ...
  runner: {
    ...
    confirmDraw: "未応募のプレゼントに実際に応募します（1 アカウントあたり最大 30 件）。応募機会は取り消せません。",
    confirmRun: "全ソースを走査後、自動で応募します（1 アカウントあたり最大 30 件）。応募機会は取り消せません。",
    confirmGo: "実行する",
    confirmNo: "やめる",
    runFailed: "起動に失敗しました",
...
const en: Dict = {
  ...
  runner: {
    ...
    confirmDraw: "This really enters the pending presents (up to 30 per account per batch). Entries cannot be undone.",
    confirmRun: "Scans all sources, then enters automatically (up to 30 per account per batch). Entries cannot be undone.",
